Project Description
CarbonIQ is a web-based platform designed to help Indian coal mines measure, analyze, and optimize their carbon footprint. The project provides real-time carbon emission tracking, a carbon footprint calculator, actionable insights, compliance monitoring, and educational resources about Indian coal mining. It features interactive maps, flashcards, and a user dashboard for managing and viewing saved data.
...
2. **Open `main.html` in your browser** to explore the platform.

3. **Navigate** using the menu to access the calculator, map, and dashboard.
